...
// Case I: When we vary R1, any one of the resistances directly connected to the voltage.
...
// Case II: When we vary R9, any one of the resistances NOT directly connected to the voltage.
...
ofstream Compare_octa("Compare_octahedron.dat");
for (int p=0; p<50; ++p){

Compare_octa << r1_val[p] << "    " << r1eq_val[p] << "    " << r9eq_val[p]  << endl;
}
